 ...
 */
public class ModifyCategoryPanel2 extends javax.swing.JPanel {
    ...
    public ModifyCategoryPanel2(CardLayout cardLayout, JPanel container, Category selectedCategory) {
        ...
        modifyCategoryMsg.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        categoryNameTF.setText(selectedCategory.getName());
        ...
        categoryDescTA.setText(selectedCategory.getDescription());
        ...
        categoryNameError.setText("Invalid name , try again");
        ...
        categoryDescError.setText("Invalid description, try again");
        ...
        modifyCategoryMsg.setText("Category modified successfully");
    ...
    private void saveChangesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveChangesButtonActionPerformed
        ...
        modifyCategoryMsg.setVisible(false);
         ...
         if(!categoryName.equals(selectedCategory.getName())){
            if(!User.validateInput(check, categoryName, Checker.StringType.LETTERS_NUMS_UNDERSCORE)){
               categoryNameError.setText("Invalid name , try again");
        ...
        if(!categoryDesc.equals(selectedCategory.getDescription())){
        ...
        if(!error){
                ...
                selectedCategory.setDescription(categoryDesc);
                CDB.updateCategory(selectedCategory);
                modifyCategoryMsg.setVisible(true);
        }

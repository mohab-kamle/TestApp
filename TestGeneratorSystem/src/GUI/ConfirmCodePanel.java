 ...
 * @author mohab
 */
public class ConfirmCodePanel extends javax.swing.JPanel {
     ...
     */
    public ConfirmCodePanel(CardLayout cardLayout, JPanel container) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Code Verification Page");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jLabel4.setText("The Code is not Correct , Please Try Again");
        ...
        jLabel3.setText("Enter The Code Sent to your email");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        jLabel5.setText("The Email Couldn't be Sent , Check your Connection");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         try {
            codeInput = jTextField1.getText();
            if (new Admin().resetPassword(EmailInput, codeInput, "", "")!=User.CODE_ERROR&&codeInput.equals(verificationCode)) {
                jLabel4.setVisible(false);
                ChangePasswordPanel changePasswordPanel = new ChangePasswordPanel(cardLayout,container);
                changePasswordPanel.setCodeEmailPassConfirm(verificationCode,EmailInput,"","");
        container.add(changePasswordPanel, "ChangePass");
        cardLayout.show(container, "ChangePass");
    ...
    public boolean sendEmail(String email) {
        ...
        this.verificationCode = EmailFunctionality.EmailUtil.generateVerificationCode();
        String subject = "Verification Code";
        String body = "Your verification code is: " + verificationCode;
        try {
            EmailFunctionality.EmailUtil.sendEmail(email, subject, body);
            return true;
        } catch (MessagingException ex) {
            System.out.println(ex.getMessage());
            return false;
